table 50040 "Forward Commission Header H"
{
    CaptionML = ENU = 'Forward Commission Header H',
                ENN = 'Forward Commission Header H';
    ...
    fields
    {
        ...
        field(22; "Entry Type"; Option)
        {
            OptionCaption = 'ForwardCommission';
            OptionMembers = ForwardCommission;
        }
    ...
    keys
    {
        key(Key1; "Entry No.", "Forward No.", "Document No.")
        {
        }
    ...
    procedure AssistEdit(ForwardCommissionHeader: Record 50040): Boolean;
    begin
        PurchSetup.GET;
        TestNoSeries;
        IF NoSeriesMgt.SelectSeries(GetNoSeriesCode, ForwardCommissionHeader."No. Series", "No. Series") THEN BEGIN
            PurchSetup.GET;
            TestNoSeries;
    ...
    begin
        CASE "Entry Type" OF
            "Entry Type"::ForwardCommission:
                EXIT(PurchSetup."Posted Forward Commission");
        END;
    end;
    ...
    begin
        CASE "Entry Type" OF
            "Entry Type"::ForwardCommission:
                PurchSetup.TESTFIELD("Posted Forward Commission");
