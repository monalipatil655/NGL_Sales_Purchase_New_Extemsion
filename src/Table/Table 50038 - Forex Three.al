    ...
    fields
    {
        ...
        field(3; "Export Invoice No."; Code[20])
        {
            ...
            begin
               ...
               // SalesInvoiceHeader.SETFILTER("Export Document", '%1', TRUE);  PCPL/NSW/MIG 25July22
                ...
                /* PCPL/NSW/MIG 25July22
                    ...
                    //SalesInvoiceHeader.CALCFIELDS("Amount to Customer"); PCPL/NSW/MIG 25July22
                    "Invoice Value" := 0;//SalesInvoiceHeader."Amount to Customer";PCPL/NSW/MIG 25July22
